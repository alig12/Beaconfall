...
// NPC Followers
#define FNPC_ENABLE_NPC_FOLLOWERS                 TRUE // Enables script macros (setfollowernpc, createfollowernpc, …). DPP-style NPC followers; increases SaveBlock3 size (may require a new save).
