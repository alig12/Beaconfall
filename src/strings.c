...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH needs you!\nPick a partner for the blackout!");
const u8 gText_ConfirmStarterChoice[] = _("Pick this partner for the blackout?");
