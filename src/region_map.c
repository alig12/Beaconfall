...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_EMBER_HOLLOW_TOWN] = {MAP_GROUP(MAP_EMBER_HOLLOW_TOWN), MAP_NUM(MAP_EMBER_HOLLOW_TOWN), HEAL_LOCATION_EMBER_HOLLOW_PLAYERS_HOUSE_2F},
    [MAPSEC_SALTWIND_PATH] = {MAP_GROUP(MAP_ROUTE1_SALTWIND_PATH), MAP_NUM(MAP_ROUTE1_SALTWIND_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_CINDER_REED_GROVE] = {MAP_GROUP(MAP_CINDER_REED_GROVE), MAP_NUM(MAP_CINDER_REED_GROVE), HEAL_LOCATION_NONE},
    [MAPSEC_BRASSFALL_CITY] = {MAP_GROUP(MAP_BRASSFALL_CITY), MAP_NUM(MAP_BRASSFALL_CITY), HEAL_LOCATION_BRASSFALL_CITY},
};
